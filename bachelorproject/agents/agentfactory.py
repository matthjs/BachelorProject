...
from bachelorproject.agents.gpqagent import GPQAgent
from bachelorproject.agents.gpsarsaagent import GPSarsaAgent
from bachelorproject.agents.randomagent import RandomAgent
