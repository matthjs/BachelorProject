...
if __name__ == "__main__":
    ...
    # sim = SimulatorRL.load(experiment_id="experiment_dummy_235", new_experiment_id="experiment_dummy_237")

    sim = SimulatorRL("LunarLander-v2", experiment_id="experiment_dummy_244")
