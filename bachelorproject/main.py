...
if __name__ == "__main__":
    ...
    sim = SimulatorRL.load(experiment_id="experiment_dummy_235", new_experiment_id="experiment_dummy_236")

    # sim = SimulatorRL("LunarLander-v2", experiment_id="experiment_dummy_235")
    ...
    (sim
     ...
     .train_agents(agent_id_list=["gpq_agent_3"], num_episodes=800, concurrent=False,
                   callbacks=[RewardCallback(), UsageCallback()])
