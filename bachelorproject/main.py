...
if __name__ == "__main__":
    sim = SimulatorRL.load(experiment_id="experiment_dummy_124")

    # sim = SimulatorRL("CartPole-v1", experiment_id="experiment_dummy_124")
    b = Backupper(sim)
    ...
    (sim
     ...
     .train_agents(num_episodes=30, concurrent=False,
