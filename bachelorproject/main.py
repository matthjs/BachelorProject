...
if __name__ == "__main__":
    ...
    # sim = SimulatorRL.load(experiment_id="experiment_dummy_245", new_experiment_id="experiment_dummy_246")
    # sim._initialize_env("LunarLander-v2")

    sim = SimulatorRL("LunarLander-v2", experiment_id="experiment_dummy_252")
    ...
    (sim
     ...
     #.train_agents(agent_id_list=["gpq_agent_3"], num_episodes=400, concurrent=False,
